...
arrest_warrants = {
    "Jonathan Ferreria": "JD123456",
    "Duncan Russell": "LO987656",
    "Ceejay Daniel": "CG876543",
    "William Harmse": "IT192783",
    "Hadley Olarte": "HT128342",
    "Gabriel Caeser": "IH123873"
}
...
def record_offence(driver_licence, arrest_warrants):
    '''Validate the drivers licence. 2 Letters followed by 6 numbers. Split and combine?'''


    #driver_licence = input("Please input the driver's licence number: ")


    #driver_name = input("Please enter the driver's full name: ")
    #posted_speed = input("Please enter the posted speed limit: ")
    #recorded_speed = input("Please enter the recorded speed of the driver: ")
