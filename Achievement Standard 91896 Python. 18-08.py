...
arrest_warrants = {
    "Jonathan Ferreria": "JD123456" "921" "10", 
    "Duncan Russell": "LO987656" "71" "70", 
    "Ceejay Daniel": "CG876543" "182" "100",
    "William Harmse": "IT192783" "77" "50",
    "Hadley Olarte": "HT128342" "108" "30",
    }

'''Stores the offences that have been recorded by the user'''
recorded_offences = {}

'''The posted speed values that are allowed.'''
posted_speed_values = {
                "30"
                "40"
                "50"
...
def speeding_fine(recorded_speed, posted_speed): #Add a rejection to the record offence if the speed is not over the speed limit.
    #Fix direction, when the speed has been accepted or rejected, return back to user choice.
    '''Calculates how fast over the speed limit the offending driver goes'''
    while True:
        speeding = posted_speed - recorded_speed
        while speeding > 0:
            print(f"Driver is going {speeding} km/h over the speed limit the fine is: \n")
            return True
        else:
...
#Incorrect password does not discontinue code.
...
while user_choice != "5":
    if user_choice == "1":
        ...
        print(f"These recorded offences of today's patrol:")
